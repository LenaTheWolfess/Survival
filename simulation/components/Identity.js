...
Identity.prototype.Schema =
	...
	"</element>"+
	"<optional>"+
		"<element name='Species' a:help='Species this unit belongs to'>" +
			"<text/>" +
		"</element>"+
	"</optional>";
...
Identity.prototype.IsSameSpecy = function(entity)
{
	let cmpIdentity = Engine.QueryInterface(entity, IID_Identity);
	if (!cmpIdentity)
		return false;
	if (this.template.Species)
		return this.template.Species == cmpIdentity.template.Species;
	return this.template.SpecificName == cmpIdentity.template.SpecificName;
}
