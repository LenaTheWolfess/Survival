...
StatusBars.prototype.OnFedChanged = function(msg)
{
	if (this.enabled)
		this.RegenerateSprites();
}
...
StatusBars.prototype.AddFedIcon = function(cmpOverlayRenderer, yoffset)
{
	if (!this.enabled)
		return 0;
	
	let cmpConsumer = Engine.QueryInterface(this.entity, IID_Consumer);
	if (!cmpConsumer || !cmpConsumer.IsFed())
		return 0;
	
	let iconSize = +this.template.BarWidth / 2;
	cmpOverlayRenderer.AddSprite(
		"art/textures/ui/session/icons/states/fed.png",
